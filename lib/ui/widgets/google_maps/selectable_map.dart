...
class GoogleSelectableMap extends StatefulWidget {
  final double latitude;
  final double longitude;

  final List<PuntoRecoleccion> puntos;

  const GoogleSelectableMap(
      {Key? key,
  ...
  @override
  GoogleSelectableMapState createState() => GoogleSelectableMapState();
}

class GoogleSelectableMapState extends State<GoogleSelectableMap> {
