...
class RouteOptimize extends StatefulWidget {
  const RouteOptimize({Key? key}) : super(key: key);

  static const routeName = '/test/route_optimize';

  @override
  RouteOptimizeState createState() => RouteOptimizeState();
}

class RouteOptimizeState extends State<RouteOptimize> {
